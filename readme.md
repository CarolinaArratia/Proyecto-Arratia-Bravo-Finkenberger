...
_*Nota: el tema seleccionado debe abordar datos medibles y graficables. Por ejemplo, no puede ser sobre "un conflicto de interés", pero sí podrían investigar sobre "el número de conflictos de interés en el gobierno y sus características o consecuencias"._
