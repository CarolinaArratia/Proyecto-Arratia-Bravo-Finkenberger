4. Documentación [Individual | formato Markdown]
[Historial de procesos y decisiones] Deben crear un archivo específico donde consignen la documentación del trabajo que realizaron para limpiar sus bases. Esta documentación es de vital importancia para la calidad de su reportaje, ya que asegura la transparencia y replicabilidad de su proceso periodístico. Debe ser entregada toda junta en un archivo README en la carpeta de entrega individual de los integrantes. Estos registros incluyen:
...
Nota: Mínimo de caracteres para esta sección: 3000.